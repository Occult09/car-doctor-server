 ...
 *    MAKE API SECURE
 * ---------------------
 * The person who should have access, only he can access the data
 * 
 * concept: 
 ...
 * 3. refresh token is used : to recreate an access tokenm that was expired
 ...
 * 2. req.cookies
 * 3. on the client side: make api call using axios withCredentials: true or credentials: 'inclue' (while using fetch)
 * 
 * */ 